...
Singleton {
    ...
    property real transparency: Config.appearance.transparency ? (m3colors.darkmode ? 0.1 : 0.07) : 0
    property real contentTransparency: Config.appearance.transparency ? (m3colors.darkmode ? 0.55 : 0.55) : 0
    ...
    m3colors: QtObject {
        ...
        property color m3background: "white"
    ...
    colors: QtObject {
        ...
        property color colLayer0: ColorUtils.mix(ColorUtils.transparentize(m3colors.m3background, root.transparency), m3colors.m3primary, Config.appearance.extraBackgroundTint ? 0.97 : 1)
    ...
    font: QtObject {
        property QtObject family: QtObject {
            ...
            property string reading: "SF Pro Display"
        }
