...
Item { // Player instance
    ...
    //         console.log(playerController.artUrl, playerController.artFilePath);
    //     }
    // }
    ...
    property QtObject blendedColors: QtObject {
        ...
        property color colSubtext: ColorUtils.mix("white", artDominantColor, 0.5)
    ...
    Rectangle { // Background
        ...
        RowLayout {
            ...
            Rectangle { // Art background
                ...
                color: ColorUtils.transparentize("white", 0.5)
